...
Также из графиков видно, что для 8 Cell CpG метилирование достаточно высокое, на стадии ICM - низкое, и на Epiblast снова высокое.
...
*Был выбран дифференциально метилированный район 2 (DMR2) гена Igf2.*

Наблюдается динамика, характерная для волн деметилирования-метилирования: снижение метилирования на стадии ICM и его повышение к стадии Epiblast. Глубина покрытия (синие треки) достаточна для надежной интерпретации данных.

<img width="1133" height="723" alt="all_samples_region (3)" src="https://github.com/user-attachments/assets/69270118-b4fe-415c-b0c2-2a1b34d58a4e" />

## DMR и DMC

Для идентификации DMR и DMC использован инструмент metilene, так как он специализирован для анализа WGBS (Whole Genome Bisulfite Sequencing) данных. Так как реплик нет, сравнивался каждый из файлов с двумя другими (1 vs 2, 3; 2 vs 1,3; 3 vs 1,2;). Параметры поиска: разница метилирования ≥50%, покрытие ≥5. Минимальное покрытие 5 исключает позиции с низкой глубиной секвенирования, где уровень метилирования может быть артефактным, а разница менее 50% может быть связана с техническим шумом или естественными колебаниями. 

|Группы сравнения | Всего DMR | Всего DMC|
|-----------------|----------|----------|
|8cell vs ICM+Epiblast|7735| 539042|
|ICM vs 8cell+Epiblast|42052| 743646|
|Epiblast vs 8cell+ICM|49031| 854948|

*Файлы с dmc и dmr слишком большие, поэтому загрузила на диск. Ссылка:* https://drive.google.com/drive/folders/1JxaK8Jg1SOpfKfemXeIh662wEuZ5WevW?usp=sharing

После поиска файлы были отфильтрованы:в качестве порога уровня значимости выбрано значение 0,05. (на диске не отфильтрованные файлы)

Результаты фильрации:

  - dmr_8cell_vs_ICM_Epiblast.bed: было 7735, стало 3882 DMR

  - dmr_ICM_vs_8cell_Epiblast.bed: было 42052, стало 35313 DMR

  - dmr_Epiblast_vs_8cell_ICM.bed: было 49031, стало 45708 DMR

  - dmc_8cell_vs_ICM_Epiblast.bed: было 539042, стало 0 DMС

  - dmc_ICM_vs_8cell_Epiblast.bed: было 743646, стало 0 DMС

  - dmc_Epiblast_vs_8cell_ICM.bed: было 854948, стало 0 DMС
